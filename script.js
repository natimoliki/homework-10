...
function createComments(item) {
  ...
  deleteBtn.addEventListener("click", function (e) {
    ...
    const deleteUrl = `https://jsonplaceholder.typicode.com/comments/${deleteId}`;
  ...
  divContainer.addEventListener("click", function () {
    ...
    const newUrl = `https://jsonplaceholder.typicode.com/comments/${postId}`;
    console.log(newUrl);
